...
This repository contains the Python scripts used to audit execution efficiency, risk-adjusted returns, and time-series performance across all trades in **Equity and F&O Options (stocks)** segments.
