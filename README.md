# Last 6 Months Trading Performance (August'25 - February'26)
**Intraday Trading in Equity & F&O Options (Stocks)**  
Fully Audited with Python

### Performance Snapshot
| Metric                  | Value              | Insight                              |
|-------------------------|--------------------|--------------------------------------|
| **Segments**            | Equity & Options (Stocks) | Real-money trades only              |
| **Net P&L (realised)**             | **₹1,20,290**      | 6.5 months                           |
...
| **Maximum Drawdown**    | **₹3,909**         | 3.2% of total profit            |

![Equity Curve](audit_results/1_equity_curve.png)  
![Maximum Drawdown](audit_results/2_drawdown.png)

### The Union Budget 2026 Masterstroke (Spike in Profit)
...
**Result**: I captured the **entire ₹1,20,872 net profit in under one hour** during the 2026 Budget speech. My preparation was so thorough that the exact announcements almost didn’t matter — the edge was already locked in.
...
- **Style**: Discretionary news-based & volume based trading (for intraday)  
